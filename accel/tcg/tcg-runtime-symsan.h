...
DEF_HELPER_FLAGS_4(symsan_store_host_i64, TCG_CALL_NO_RWG, void, i64, ptr,
                   i64, i64)
/* Guest memory */
DEF_HELPER_FLAGS_5(symsan_load_guest_i32, TCG_CALL_NO_RWG, i64,
                     env, dh_alias_tl, i64, i64, i64)
DEF_HELPER_FLAGS_5(symsan_load_guest_i64, TCG_CALL_NO_RWG, i64,
                     env, dh_alias_tl, i64, i64, i64)
DEF_HELPER_FLAGS_6(symsan_store_guest_i32, TCG_CALL_NO_RWG, void,
...
DEF_HELPER_FLAGS_4(symsan_check_store_guest, TCG_CALL_NO_RWG, void,
                    env, dh_alias_tl, i64, i64)
